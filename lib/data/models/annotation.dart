...
class Annotation {
  ...
  factory Annotation.fromJson(Map<String, dynamic> json) {
    return Annotation(
      ...
      timestampUtc: json['timestamp'] != null || json['timestamp_utc'] != null
          ? DateTime.parse(
              json['timestamp'] as String? ?? json['timestamp_utc'] as String? ?? DateTime.now().toIso8601String(),
            )
          : DateTime.now(),
      elapsedMs: json['elapsed_ms'] as int? ?? 0,
      phase: SessionPhase.fromString(json['phase'] as String? ?? 'pre_surgery'),
      category: AnnotationCategory.fromString(json['category'] as String? ?? 'system'),

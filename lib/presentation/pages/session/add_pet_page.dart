  ...
  Future<void> _savePet() async {
    ...
    try {
      final animal = await _animalRepo.createAnimal(
        ...
        breed: breed.value,
        ageYears: double.tryParse(ageController.text) ?? 1.0,
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => SegmentedButton<Species>(
                  segments: Species.values.map((s) => ButtonSegment(
                    value: s,
                    label: Text(s.displayName),
                    icon: Icon(
                      s == Species.dog ? Icons.pets : 
                      s == Species.cat ? Icons.cruelty_free : Icons.help,
                    ),
                  )).toList(),
                ...
                Obx(() => DropdownButtonFormField<String>(
                  ...
                  items: breedList.map((b) => DropdownMenuItem(
                    value: b,
                    child: Text(b),
                  )).toList(),
